	...
	def perfromJobAction(String Action , String TestCaseName , extentTest) {
		...
		switch (Action) {
			...
			case 'job_detail_resubmit_btn':
				...
				WebUI.click(newJobAction)
				WebUI.delay(2)
				def isElementPresent=(new customWait.WaitForElement()).WaitForelementPresent(findTestObject('Object Repository/JobDetailsPage/Msg_ResubmitWarning'), 10,extentTest, 'Resubmit Warning')
				if(isElementPresent) {
